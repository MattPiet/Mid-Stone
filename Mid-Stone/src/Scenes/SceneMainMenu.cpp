...
void SceneMainMenu::PlayerShoot() {
...
void SceneMainMenu::RenderGUI()
{
    ...
    UIManager::StartInvisibleWindow(ImVec2(500, 500));
    UIManager::PushButtonStyle(b, g, r, 90.0f); // pushing button style
    if (ImGui::Button("Attack")) { // making a button to toggle hitbox drawing
        mainPlayerActor->GetAnimator()->playAnimationClip("Attack");
    }
    UIManager::PopButtonStyle(); // popping button style
...
void SceneMainMenu::Render() const
{
